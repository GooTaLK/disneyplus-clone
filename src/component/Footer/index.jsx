    ...
    <footer className={newClass !== '' ? `${newClass} Footer` : 'Footer'}>
      ...
      <div className='Footer-actions'>
        <span className='Footer-selectLanguage'>
          <svg class='Footer-globe' viewBox='0 0 710 724'>
            <path class='cls-1' d='M347.2,92.13a273.81,273.81,0,1,1-106.93,21.58A273,273,0,0,1,347.2,92.13m0-33c-170,0-307.74,137.79-307.74,307.75S177.24,674.62,347.2,674.62,655,536.84,655,366.88,517.17,59.13,347.2,59.13Z' />
            <path class='cls-2' d='M373.5,77.5s108,59,108,297c0,220-116,283-116,283' />
            <path class='cls-2' d='M325.91,77.5S210,136.5,210,374.5c0,220,124.5,283,124.5,283' />
            <path class='cls-2' d='M100,211s111,24,247,24c134,0,239-24,239-24' />
            <path class='cls-2' d='M586,521s-111-24-247-24c-134,0-239,24-239,24' />
            <line class='cls-2' x1='59' y1='367' x2='635' y2='367' />
          </svg>
          <svg class='Footer-down' viewBox='0 0 48 48'>
